...
require_relative 'comet/models/admin_options'
...
require_relative 'comet/models/browse_proxmox_nodes_response'
require_relative 'comet/models/browse_proxmox_response'
require_relative 'comet/models/browse_proxmox_storage_response'
require_relative 'comet/models/browse_sqlserver_response'
require_relative 'comet/models/browse_vmware_datacenters_response'
require_relative 'comet/models/browse_vmware_datastores_response'
require_relative 'comet/models/browse_vmware_hosts_response'
require_relative 'comet/models/browse_vmware_networks_response'
...
require_relative 'comet/models/hyper_vrestore_target_options'
...
require_relative 'comet/models/partition_conflict'
...
require_relative 'comet/models/pvebackup_disk'
...
require_relative 'comet/models/vmdisk_info'
require_relative 'comet/models/vmdksnapshot_view_options'
require_relative 'comet/models/vminfo'
require_relative 'comet/models/vminfo_list'
require_relative 'comet/models/vmware_connection'
require_relative 'comet/models/vmware_datacenter_info'
require_relative 'comet/models/vmware_datastore_info'
require_relative 'comet/models/vmware_host_info'
require_relative 'comet/models/vmware_machine_info'
require_relative 'comet/models/vmware_network_info'
require_relative 'comet/models/vmware_restore_target_options'
