...
module Comet
  ...
  RETENTIONRANGE_MAXINT = 1125899906842624
  ...
  # 2^50 (1 << 50)
  SCHEDULE_MAXINT = 1125899906842624
  ...
  UnknownDeviceError = "ERR_UNKNOWN_DEVICE"
  
  TOTPRequiredError = "ERR_TOTP_REQUIRED"
  ...
  EMAIL_DELIVERY_BUILTIN = Comet::EMAIL_DELIVERY_MX_DIRECT
